...
# مجموعة قواعد الجودة (تغطي الأبعاد المطلوبة: الاكتمال، التفرد، الصحة، والاتساق)
SUITE = [
...
def validate(df, suite):
    """تنفيذ مجموعة القواعد وإرجاع تقرير بالنتائج بدلاً من النقص."""
    results = []
    for rule in suite:
...
def check_schema_drift(df):
    """التحقق من الانحراف الهيكلي ضد ملف الأساس وتفريق الأعمدة المفقودة عن الجديدة."""
...
def reconcile(date_str):
    """مطابقة عدد الصفوف في ملف الـ CSV مع ما تم تحميله في المستودع."""
